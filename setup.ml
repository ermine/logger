...
(* OASIS_START *)
(* DO NOT EDIT (digest: c6e07a6d3660b9a8eb62179254d736cd) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Pa_logger"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "erm_logger";
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/ermine/logger.git";
                      src_repo_browser =
                        Some "https://github.com/ermine/logger";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\130^\025iBî\"\133ÅU=qT^@\024";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
